#!/usr/bin/env python3
"""
API de rendu vidéo pour VideoSeq
"""
...
app = FastAPI(title="VideoSeq Render Service")
...
@app.get("/")
def root():
    return {"status": "ok", "service": "VideoSeq Render API"}
...
async def render_video(
    ...
    try:
        ...
        print(f"🎬 Rendu VideoSeq - Durée: {total_duration:.2f}s, Grille: {grid_cols}x{grid_rows}")
